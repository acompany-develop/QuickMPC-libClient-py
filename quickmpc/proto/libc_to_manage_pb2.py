...
_GETCOMPUTATIONRESULTRESPONSETEST = DESCRIPTOR.message_types_by_name[
...
GetComputationResultResponseTest = _reflection.GeneratedProtocolMessageType('GetComputationResultResponseTest', (_message.Message,), {
    'DESCRIPTOR': _GETCOMPUTATIONRESULTRESPONSETEST,
    '__module__': 'libc_to_manage_pb2'
    # @@protoc_insertion_point(class_scope:libctomanage.GetComputationResultResponseTest)
})
_sym_db.RegisterMessage(GetComputationResultResponseTest)
...
if _descriptor._USE_C_DESCRIPTORS == False:
    ...
    _GETCOMPUTATIONRESULTRESPONSETEST._serialized_start = 1726
    _GETCOMPUTATIONRESULTRESPONSETEST._serialized_end = 1992
    _LIBCTOMANAGE._serialized_start = 1995
    _LIBCTOMANAGE._serialized_end = 2956
